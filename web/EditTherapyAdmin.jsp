...
<body>
    <div class="container">
        ...
        <form action="TherapyServlet" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="therapy_id" value="<%= therapy.getTherapyId() %>">

            <d <!-- Current Picture at the Top without Label -->
                <img src="uploads/<%= therapy.getTherapyPicture()%>" width="250">

            <div class="form-group">
                <label for="therapy_package">Package Name:</label>
                <input type="text" id="therapy_package" name="therapy_package" value="<%= therapy.getTherapyPackage() %>" required>
            </div>

            <div class="form-group">
                <label for="therapy_price">Price (RM):</label>
                <input type="number" id="therapy_price" name="therapy_price"value="<%= String.format("%.2f", therapy.getTherapyPrice())%>" required>
            </div>

            <div class="form-group">
                <label for="therapy_picture">Upload New Picture:</label>
                <input type="file" id="therapy_picture" name="therapy_picture" accept="image/*">
            </div>

            <button type="submit" class="btn-submit">Update Therapy</button>
        </form>
        ...
        <button class="btn-back" onclick="window.location.href='AdminTherapyList.jsp';">Back to Therapy List</button>
    </div>
